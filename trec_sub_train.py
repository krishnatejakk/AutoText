...
setattr(configuration, 'num_classes', 6)
...
tokenized_datasets = tokenized_datasets.remove_columns(["text", "label-fine"])
tokenized_datasets = tokenized_datasets.rename_column("label-coarse", "labels")
...
setf_model = OMPGradMatchStrategy(train_dataloader, train_dataloader, model1, criterion_nored,
